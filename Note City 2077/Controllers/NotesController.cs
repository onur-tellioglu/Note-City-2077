...
namespace NoteApp.Controllers
{
    public class NotesController : Controller
    {
        ...
        {
            return View("Index", await _context.Note.Where(n => n.NoteHeader.Contains(SearchPhrase)).ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,NoteHeader,NoteBody")] Note note)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NoteHeader,NoteBody")] Note note)
        {
            if (id != note.Id)
            {
                return NotFound();
